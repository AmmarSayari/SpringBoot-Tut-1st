...
public class RunRepository {
    ...
    public void create(Run run){
        var updated = jdbcClient.sql("INSERT INTO run(id, title, startedOn, endedOn, miles,location) values(?,?,?,?,?,?)")
    ...
    public void update(Run run, Integer id){
        var updated = jdbcClient.sql("UPDATE run SET title = ?, startedOn = ?, endedOn = ?, miles = ?, location = ? WHERE id = ?")
